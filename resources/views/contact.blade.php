                ...
                <form action="{{ route('contact.submit') }}" method="POST" class="space-y-6" id="contact-form">
                    ...
                    <div>
                        ...
                        <textarea id="message" name="message" rows="5"
                            class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm input-focus @error('message') border-red-500 @enderror" required>{{ old('message') }}</textarea>
                        @error('message')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="space-y-8">
                ...
                <div class="bg-gray-50 p-8 rounded-xl shadow-lg card-hover">
                    ...
                    <ul class="space-y-4 text-gray-600">
                        ...
                        <li class="flex items-start">
                            ...
                            <a href="tel:{{ $contactInfo ? $contactInfo->phone : '+970-59-999999' }}" class="hover:text-yellow-400">
                        ...
                        <li class="flex items-start">
                            ...
                            <a href="mailto:{{ $contactInfo ? $contactInfo->email : 'info@royalsecurity.ps' }}" class="hover:text-yellow-400">
                ...
                <div class="bg-gray-50 p-8 rounded-xl shadow-lg card-hover">
                    ...
                    <div class="h-64 bg-gray-200 rounded-lg flex items-center justify-center">
                        {!! $contactInfo && $contactInfo->map_embed ? $contactInfo->map_embed : '<p class="text-gray-500">' . (app()->getLocale() === 'ar' ? 'عنصر نائب للخريطة التفاعلية (قم بتضمين خرائط جوجل أو ما شابه هنا)' : 'Interactive Map Placeholder (Embed Google Maps or similar here)') . '</p>' !!}
                    </div>
                </div>
            </div>
        </div>
