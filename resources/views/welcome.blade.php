            ...
            <div class="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div class="relative" data-aos="fade-right">
                    <div class="relative z-10 rounded-2xl overflow-hidden shadow-2xl">
                        ...
                        <!-- Decorative Elements -->
                        <div
                            class="absolute -bottom-6 -left-6 w-32 h-32 bg-yellow-400 rounded-full mix-blend-multiply filter blur-xl opacity-20">
                        </div>
                        <div
                            class="absolute -top-6 -right-6 w-32 h-32 bg-blue-400 rounded-full mix-blend-multiply filter blur-xl opacity-20">
                        </div>
                    </div>

                    <!-- Experience Badge -->
                    <div class="absolute -bottom-6 -right-6 bg-white rounded-xl shadow-lg p-6 text-center z-20"
                        data-aos="fade-up" data-aos-delay="300">
                        <div class="text-4xl font-bold text-yellow-500">15+</div>
                        <div class="text-sm font-medium text-gray-600">
                            {{ app()->getLocale() === 'ar' ? 'سنة خبرة' : 'Years Experience' }}</div>
                    </div>
                </div>
                ...
                <div data-aos="fade-left" data-aos-delay="100">
                    <!-- Section Title -->
                    <div
                        class="inline-flex items-center px-4 py-2 rounded-full bg-yellow-50 text-yellow-600 text-sm font-medium mb-6">
                            ...
                            @foreach ($about->features as $feature)
                                <div class="flex items-start group">
                                    <div class="flex-shrink-0 mt-1 mr-4">
                                        <div
                                            class="flex items-center justify-center w-10 h-10 rounded-full bg-yellow-50 text-yellow-500 group-hover:bg-yellow-100 transition-colors duration-300">
                                    ...
                                    <div>
                                        <h4 class="text-lg font-semibold text-gray-900 mb-1">
                                            {{ $feature['feature_' . app()->getLocale()] }}</h4>
                                        <p class="text-gray-600 text-sm">
                                            {{ $feature['description_' . app()->getLocale()] ?? '' }}</p>
                                    </div>
                                </div>
                            @endforeach
                        @else
                            ...
                            <div class="flex items-start group">
                                <div class="flex-shrink-0 mt-1 mr-4">
                                    <div
                                        class="flex items-center justify-center w-10 h-10 rounded-full bg-blue-50 text-blue-500 group-hover:bg-blue-100 transition-colors duration-300">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="flex items-start group">
                                <div class="flex-shrink-0 mt-1 mr-4">
                                    <div
                                        class="flex items-center justify-center w-10 h-10 rounded-full bg-green-50 text-green-500 group-hover:bg-green-100 transition-colors duration-300">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
