...
@section('title', __('Manage Testimonials'))
...
@push('styles')
    <style>
        ...
        /* Client column avatar positioning */
        .client-column-container {
            display: flex;
            align-items: center;
        }

        .client-column-container .avatar {
            margin-right: 1rem;
            /* Default for LTR */
        }

        [dir="rtl"] .client-column-container {
            flex-direction: row-reverse;
        }

        [dir="rtl"] .client-column-container .avatar {
            margin-right: 0;
            margin-left: 1rem;
            /* For RTL */
        }
        ...
        <div class="md:flex md:items-center md:justify-between mb-8">
            <div class="flex-1 min-w-0">
                ...
                <p class="mt-1 text-sm text-gray-500">
                    {{ __('Manage client testimonials to showcase on your website') }}
                </p>
            </div>
            <div class="mt-4 flex md:mt-0 md:ml-4 {{ app()->getLocale() === 'ar' ? 'md:mr-4' : '' }}">
                <a href="{{ route('dashboard.testimonials.create') }}"
                    class="ml-3 inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-yellow-600 hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 {{ app()->getLocale() === 'ar' ? 'mr-3' : '' }}">
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="client-column-container">
                                        ...
                                        <div>
                                            <div class="text-sm font-medium text-gray-900">{{ $testimonial->name_en }}
                                            </div>
                                            <div class="text-sm text-gray-500" dir="rtl">{{ $testimonial->name_ar }}
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">{{ $testimonial->position_en }}</div>
                                    <div class="text-sm text-gray-500" dir="rtl">{{ $testimonial->position_ar }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        @endfor
                                        <span
                                            class="ml-2 text-sm text-gray-500 {{ app()->getLocale() === 'ar' ? 'mr-2' : '' }}">{{ $testimonial->rating }}.0</span>
                                    </div>
                                </td>
                                <td
                                    class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium {{ app()->getLocale() === 'ar' ? 'text-left' : '' }}">
                                    <div
                                        class="flex justify-end space-x-2 {{ app()->getLocale() === 'ar' ? 'justify-start space-x-reverse' : '' }}">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <div
                                                        class="mt-3 text-center sm:mt-5 {{ app()->getLocale() === 'ar' ? 'sm:text-right' : 'sm:text-left' }}">
                                                ...
                                                <div
                                                    ...
                                                    <form
                                                        action="{{ route('dashboard.testimonials.delete', $testimonial) }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center">
                                    ...
                                    <h3 class="mt-2 text-sm font-medium text-gray-900">{{ __('No testimonials') }}</h3>
                                    <p class="mt-1 text-sm text-gray-500">
                                        {{ __('Get started by adding a new testimonial.') }}</p>
                                    <div class="mt-6">
                                        <a href="{{ route('dashboard.testimonials.create') }}"
            ...
            @if ($testimonials->hasPages())
                <div class="bg-gray-50 px-6 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
                    <div class="flex-1 flex justify-between sm:hidden">
                        ...
                        @if ($testimonials->hasMorePages())
                            <a href="{{ $testimonials->nextPageUrl() }}"
                                class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 {{ app()->getLocale() === 'ar' ? 'mr-3' : '' }}">
                                {{ __('Next') }}
                            </a>
                        @else
                            <span
                                class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-300 bg-white {{ app()->getLocale() === 'ar' ? 'mr-3' : '' }}">
                                {{ __('Next') }}
                            </span>
                        @endif
                    </div>
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        ...
                        <div>
                            <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px {{ app()->getLocale() === 'ar' ? '-space-x-reverse' : '' }}"
