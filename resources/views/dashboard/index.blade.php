...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <!-- Welcome Header -->
    <div class="text-center py-12" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
        ...
        <p class="text-xl text-gray-600 max-w-3xl mx-auto" data-aos="fade-up" data-aos-delay="100">
            @if(app()->getLocale() === 'ar')
                قم بإدارة محتوى وإعدادات موقعك بكفاءة
            @else
                Manage your website content and settings efficiently
            @endif
        </p>
    </div>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <a href="{{ route('dashboard.portfolio.create') }}" class="group p-4 border border-gray-200 rounded-lg hover:bg-yellow-50 transition-colors">
                    <div class="flex items-center">
                        ...
                        <span class="ml-3 font-medium text-gray-700">
                            @if(app()->getLocale() === 'ar')
                                إضافة عنصر إلى الأعمال السابقة
                            @else
                                Add Portfolio Item
                            @endif
                        </span>
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p class="text-gray-600 mt-1">
                        @if(app()->getLocale() === 'ar')
                            تخصيص محتوى صفحة الترحيب بموقعك الإلكتروني
                        @else
                            Customize your website\'s welcome page content
                        @endif
                    </p>
                </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-red-700 mb-4">
                            @if(app()->getLocale() === 'ar')
                                تحديث العناوين، الأوصاف، الصور، ومحتويات أخرى معروضة على صفحة الترحيب بموقعك الإلكتروني
                            @else
                                Update headlines, descriptions, images, and other content displayed on your website\'s welcome page
                            @endif
                        </p>
                        <div class="flex items-center text-sm text-red-600">
                            ...
                            @if(app()->getLocale() === 'ar')
                                التغييرات ستظهر فوراً على موقعك الإلكتروني المباشر
                            @else
                                Changes will be reflected immediately on your live website
                            @endif
                        </div>
                    </div>
                    <div class="ml-6">
